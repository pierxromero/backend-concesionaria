...
public class CompraValidacion {
      ...
      public static Double validarMontoInicial(String montoInicialStr, Double precioVehiculo) throws FormatoInvalidoException {
          ...
          double montoMinimo = precioVehiculo * 0.30; // 50% del precio del vehículo
          ...
          if (montoInicial < montoMinimo) {
              throw new FormatoInvalidoException("El monto inicial no puede ser menor al 30% del precio del vehículo. Mínimo requerido: $" + montoMinimo);
          }
